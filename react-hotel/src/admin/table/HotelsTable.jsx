...
const columns = [
    ...
    {
        field: 'photos', headerName: 'Image', width:50,

      
    },
    { field: 'name', headerName: 'Hotel Name', width: 150 },
    { field: 'type', headerName: 'Hotel Type', width: 100 },
...
export default function DataTable() {
    ...
    return (
        <div style={{ height: 400, width: '100%' }}>
            <Link to="/admin/hotels/new" style={{ fontWeight: "bold", color: "greenyellow", textDecoration: "none", outline: "none", cursor: "pointer", fontSize: "20px", border: "2px gray", margin: "5px" }}> + Add New</Link>
            <DataGrid
                rows={data}
                columns={columns}
                pageSize={5}
